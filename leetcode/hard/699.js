...
any square we have dropped, after dropping squares represented 
...
__aaa __aaa __aaa _aa__ _aa__ -------------- 
The maximum height of any square is 5. 

The larger square stays on top of the smaller square despite 
...
const input1 = [[1, 2], [2, 3], [6, 1]]
const output1 = [2, 5, 5]

console.log(fallingSquares(input1), output1)
