...
When a vertical domino has dominoes falling on 
it from both sides, it stays still due to the balance of the forces.

For the purposes of this question, 
we will consider that a falling domino expends no 
...
const input1 = ".L.R...LR..L.."
const output1 = "LL.RR.LLRRLL.."

const input2 = "RR.L"
const output2 = "RR.L"

console.log(pushDominoes(input1), output1)
console.log(pushDominoes(input2), output2)
